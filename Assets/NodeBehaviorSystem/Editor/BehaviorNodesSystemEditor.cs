...
{
    [CustomEditor(typeof(BehaviorNodesSystem))]
    public class BehaviorNodesSystemEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            BehaviorNodesSystem css = (BehaviorNodesSystem)target;
        ...
        bool checkNameInSwitchList(string name, BehaviorNodesSystem css)
        {
            foreach (GameSwitch gameSwitch in css.switchVariables)
            {
